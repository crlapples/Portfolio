    ...
    <main className="mainContainer">
      ...
      <div className="contentContainer">
        ...
        <div className="projectContainer">
          <div className="projectContentContainer">
            <div className="imgContainer">
              <a href="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase1%20(1).png" target="_blank" rel="noopener noreferrer"><img className="knightsImg" src="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase1%20(1).png" /></a>
              <label className="imgLabel">Original website with logo, navigation bar and welcome header</label>
            </div>
            <div className="imgContainer">
              <a href="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase2%20(1).png" target="_blank" rel="noopener noreferrer"><img className="knightsImg" src="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase2%20(1).png" /></a>
              <label className="imgLabel">Original website first introduction app</label>
            </div>
            <div className="imgContainer">
              <a href="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase3%20(1).png" target="_blank" rel="noopener noreferrer"><img className="knightsImg" src="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase3%20(1).png" /></a>
              <label className="imgLabel">Original website second introduction app</label>
            </div>
            <div className="imgContainer">
              <a href="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase4%20(1).png" target="_blank" rel="noopener noreferrer"><img className="knightsImg" src="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase4%20(1).png" /></a>
              <label className="imgLabel">Original website third introduction app</label>
            </div>
            <div className="imgContainer">
              <a href="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase1.png" target="_blank" rel="noopener noreferrer"><img className="knightsImg" src="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase1.png" /></a>
              <label className="imgLabel">New website with new header image</label>
            </div>
            <div className="imgContainer">
              <a href="https://assets.onecompiler.app/42xjnjtme/43a9pnrnp/AppShowcase2.png" target="_blank" rel="noopener noreferrer"><img className="knightsImg" src="https://assets.onecompiler.app/42xjnjtme/43a9pnrnp/AppShowcase2.png" /></a>
              <label className="imgLabel">New website web page title</label>
            </div>
            <div className="imgContainer">
              <a href="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase3.png" target="_blank" rel="noopener noreferrer"><img className="knightsImg" src="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase3.png" /></a>
              <label className="imgLabel">New website first row of app list</label>
            </div>
            <div className="imgContainer">
              <a href="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase4.png" target="_blank" rel="noopener noreferrer"><img className="knightsImg" src="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase4.png" /></a>
              <label className="imgLabel">New website, individual app details web page part one</label>
            </div>
            <div className="imgContainer">
              <a href="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase5.png" target="_blank" rel="noopener noreferrer"><img className="knightsImg" src="https://assets.onecompiler.app/42xjnjtme/43a9ndqvh/AppShowcase5.png" /></a>
